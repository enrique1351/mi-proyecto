...
from shared.core.data.data_manager import DataIngestion
...
from shared.core.constants import ASSETS, TRADING_CONFIG
...
class QuantTradingSystem:
    ...
    def _initialize_system(self):
        ...
        try:
            ...
            self.credential_vault = CredentialVault(environment="local")
    ...
    def _register_assets(self):
        ...
        # Crypto
        crypto_assets = ASSETS.get('crypto', {}).get('spot', {}).get('majors', [])
